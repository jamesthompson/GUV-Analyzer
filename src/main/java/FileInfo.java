 ...
 * This should really be rewritten as an enum class. 
 */
...
public class FileInfo implements Cloneable {
    ...
    /**
     * 32-bit signed integer. Imported 32-bit integer images are converted to
     * floating-point.
     */
    ...
    /**
     * 32-bit unsigned integer. Imported 32-bit integer images are converted to
     * floating-point.
     */
    ...
    /*
     * File format (TIFF, GIF_OR_JPG, BMP, etc.). Used by the File/Revert
     * command
     */
    ...
    /**
     * Creates a FileInfo object with all of its fields set to their default
     * value.
     */
    public FileInfo() {
